...
description: >-
  ...
  libraries, and mixed work. Do not use while the idea is fuzzy or "done" is
  undefined (feature-specifier), for a new project, prototype, or MVP
  (mvp-specifier), or when the code already exists and the user wants it
  reviewed (feature-code-reviewer) or tested (feature-tester).
compatibility: >-
